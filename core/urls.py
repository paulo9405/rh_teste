...
urlpatterns = [
    ...
    path('company/', list_company, name='core_list_company'),
    ...
    path('company/department/', list_department, name='core_list_department'),
    ...
    path('company/employee/', list_employee, name='core_list_employee'),
